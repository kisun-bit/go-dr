...
type LinuxCmder struct{}

// LinuxCommand的初始化函数
func NewLinuxCmd() *LinuxCmder {
	return &LinuxCmder{}
}
...
func (lc *LinuxCmder) Exec(args ...string) (int, string, error) {
...
func (lc *LinuxCmder) ExecAsync(stdout chan string, args ...string) int {
...
// args: 命令行参数
// return: 错误消息
func (lc *LinuxCmder) ExecIgnoreResult(args ...string) error {
	args = append([]string{"-c"}, args...)
	cmd := exec.Command(os.Getenv("SHELL"), args...)
